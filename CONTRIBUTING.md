...
For this reason, [alleged privacy issues](https://github.com/Tobi823/ffupdater/issues/35), and [the lack of frequent updates](https://github.com/kiwibrowser/src.next/commits/kiwi) ([including unpatched vulnerabilities](https://github.com/kiwibrowser/src.next/issues/1001)), I would recommend against using this browser.
