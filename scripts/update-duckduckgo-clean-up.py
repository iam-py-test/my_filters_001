...
pupdomains = open("Alternative list formats/anti-pup_domains.txt").read().split("\n")
pupips = open("Alternative list formats/anti-pup_ips.txt").read().split("\n")
...
for line in pupdomains:
  if line == '' or line.startswith("!"):
    continue
  totalpups += """duckduckgo.com,3g2upl4pq6kufc4m.onion,duckduckgogg42xjoc72x3sjasowoarfbgcmvfimaftt6twagswzczad.onion##[data-nrn="result"]:has(a[href*="://{}"])\nduckduckgo.com,3g2upl4pq6kufc4m.onion,duckduckgogg42xjoc72x3sjasowoarfbgcmvfimaftt6twagswzczad.onion##.result:has(a[href*="://{}"])\n""".format(line,line)
